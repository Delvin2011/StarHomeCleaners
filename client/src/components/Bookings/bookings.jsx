...
class Bookings extends React.Component {
  ...
  render() {
    ...
    const PromoCode = this.props.currentUser
          ...
          <Popup>
            <PopupInner>
              ...
              <TabsContainer>
                <GridContainer>
                  <GridItem
                    style={{ paddingLeft: "5px", "padding-right": "5px" }}
                  >
                    <NavPills
                      alignCenter
                      color="rose"
                              ...
                              {this.props.currentUser ? (
                                this.props.cartItems.length > 0 ? (
                                  <div style={{ marginTop: "-5px" }}>
                                    ...
                                    {Object.entries(this.props.cartItems).map(
                                      ([key, val]) => (
                                        <Details key={key}>
                                          <BookingDetail>
                                            {
                                              this.props.cartItems[key]
                                                .serviceDate
                                            }
                                          </BookingDetail>
                                          <BookingDetail>
                                            {this.props.cartItems[key].category}
                                          </BookingDetail>
                                          <BookingDetail>
                                            {this.props.cartItems[key].service}
                                          </BookingDetail>
                                          <BookingDetail>
                                            {
                                              this.props.cartItems[key]
                                          ...
                                          <BookingDetail>
                                            {this.props.cartItems[key].payment}
                                          </BookingDetail>
                                          <Tooltip
                                ...
                                <div>
                                  ...
                                  <p style={{ textAlign: "center" }}>
                                    <CustomButton
                                      onClick={this.showPopupSignIn.bind(this)}
                                      style={{
                                        marginTop: "12.5px",
                                        background: "#e91e63",
                                      }}
                            ...
                            <div>
                              {this.props.currentUser ? (
                                <div style={{ marginTop: "-5px" }}>
                                  ...
                                  <TCList>
                                    <li>
                                      Use Promo Code for your next booking.
                                    </li>
                                  ...
                                  <DetailHeader>
                                    Friend Referal Code : {FriendCode}
                                  </DetailHeader>
                                  <TCList>
                                    <li>
                                      Refer 3 friends to book with us, using the
                                      Code.
                                    </li>
                                    <li>
                                      Friend's successful booking attracts 20%
                                      discount on 1st booking.
                                    </li>
                                    <li>
                                      You get 50% discount for 3 successful
                                      friends referrals.
                                    </li>
                                  </TCList>
                                </div>
                                ...
                                <div>
                                  ...
                                  <TCList>
                                    <br />
                                    <li>
                                      View customised promotion discounts.
                                    </li>
                                    <li>
                                      Get 20% discount coupon for two referrals.
                                    </li>
                                    <li>
                                      Get promotion discount for your next
                                      order.
                                    </li>
                                  </TCList>
                                  <br />
            ...
            {this.state.showPopupSignIn ? (
              <SignIn
                showPopupSignIn={this.state.showPopupSignIn}
                closePopupSignIn={this.showPopupSignIn.bind(this)}
