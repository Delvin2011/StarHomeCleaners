              ...
              <Card className={classes[cardAnimaton]}>
                <form className={classes.form}>
                  ...
                  <Heading>Proceed to Home Page?</Heading>
                      <br/>
                      <p style = {{"textAlign" : "center"}}><CustomButton onClick={() => { history.push('/');}} style = {{"margin-top" : "12.5px", "background": "#e91e63"}} size="sm">Home</CustomButton></p> 
                      <br/>
                  </Container>
                </form>
              </Card>
